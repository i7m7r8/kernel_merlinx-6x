...
static const struct mtk_gate infra_clks[] = {
	...
	GATE_INFRA(CLK_INFRA_AUD, "infra_aud", "univpll_d2", 32),
	GATE_INFRA(CLK_INFRA_AUDIO_26M_B, "infra_audio_26m_b", "clk26m", 33),
	GATE_INFRA(CLK_INFRA_MD_32K, "infra_md_32k", "clk32k", 34),
	GATE_INFRA(CLK_INFRA_MD_SYS, "infra_md_sys", "univpll_d2", 35),
};
